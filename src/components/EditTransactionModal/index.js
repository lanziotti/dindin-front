...
function EditTransactionModal({ open, handleClose, setTransactions, currentItemToEdit }) {
    ...
    useEffect(() => {
        if (currentItemToEdit) {
            const { categoria_id, categoria_nome, data, descricao, tipo, valor } = currentItemToEdit;
